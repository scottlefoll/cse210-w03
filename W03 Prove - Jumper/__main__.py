...
Seeker is a game in which the player seeks to find the hider by guessing its 
location. The hider gives hints until it is found.
...
If the guess is farther away from the hider's location it says, "Getting 
colder!"
